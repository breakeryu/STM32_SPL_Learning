...
/*
	...
	APB1 定时器的输入时钟 TIMxCLK = SystemCoreClock / 2; 36M
	APB2 定时器的输入时钟 TIMxCLK = SystemCoreClock; 72M
*/
...
*********************************************************************************************************
*/
void bsp_SetAFofTIM(TIM_TypeDef* TIMx)
{
	...
	if (TIMx == TIM1) {
      ...
      __HAL_AFIO_REMAP_TIM1_DISABLE();//DISABLE: No remap      (ETR/PA12, CH1/PA8, CH2/PA9,  CH3/PA10, CH4/PA11, BKIN/PB12, CH1N/PB13, CH2N/PB14, CH3N/PB15)
      //__HAL_AFIO_REMAP_TIM1_ENABLE(); //ENABLE: Full remap     (ETR/PE7,  CH1/PE9, CH2/PE11, CH3/PE13, CH4/PE14, BKIN/PE15, CH1N/PE8,  CH2N/PE10, CH3N/PE12)
      //__HAL_AFIO_REMAP_TIM1_PARTIAL();//PARTIAL: Partial remap (ETR/PA12, CH1/PA8, CH2/PA9,  CH3/PA10, CH4/PA11, BKIN/PA6,  CH1N/PA7,  CH2N/PB0,  CH3N/PB1)
    }
      
	else if (TIMx == TIM2) {
      __HAL_RCC_AFIO_CLK_ENABLE();
     
      //__HAL_AFIO_REMAP_TIM2_ENABLE();//ENABLE: Full remap       (CH1/ETR/PA15, CH2/PB3, CH3/PB10, CH4/PB11)
      //__HAL_AFIO_REMAP_TIM2_PARTIAL_2();//PARTIAL_2: Partial remap (CH1/ETR/PA0,  CH2/PA1, CH3/PB10, CH4/PB11)
      //__HAL_AFIO_REMAP_TIM2_PARTIAL_1();//PARTIAL_1: Partial remap (CH1/ETR/PA15, CH2/PB3, CH3/PA2,  CH4/PA3)
      __HAL_AFIO_REMAP_TIM2_DISABLE();//DISABLE: No remap        (CH1/ETR/PA0,  CH2/PA1, CH3/PA2,  CH4/PA3)
      ...
      //__HAL_AFIO_REMAP_TIM3_ENABLE();//ENABLE: Full remap     (CH1/PC6, CH2/PC7, CH3/PC8, CH4/PC9)
      //__HAL_AFIO_REMAP_TIM3_PARTIAL();//PARTIAL: Partial remap (CH1/PB4, CH2/PB5, CH3/PB0, CH4/PB1)
      __HAL_AFIO_REMAP_TIM3_DISABLE();//DISABLE: No remap      (CH1/PA6, CH2/PA7, CH3/PB0, CH4/PB1)
      ...
      //__HAL_AFIO_REMAP_TIM4_ENABLE();//ENABLE: Full remap (TIM4_CH1/PD12, TIM4_CH2/PD13, TIM4_CH3/PD14, TIM4_CH4/PD15)
      __HAL_AFIO_REMAP_TIM4_DISABLE();//DISABLE: No remap  (TIM4_CH1/PB6,  TIM4_CH2/PB7,  TIM4_CH3/PB8,  TIM4_CH4/PB9)
...
void bsp_ConfigTimGpio(GPIO_TypeDef* GPIOx, uint16_t GPIO_PinX, TIM_TypeDef* TIMx)
{
    ...
    //bsp_SetAFofTIM(TIMx);//需要自己设置复用方式
...
void bsp_SetTIMforInt(TIM_TypeDef* TIMx, uint32_t _ulFreq, uint8_t _PreemptionPriority, uint8_t _SubPriority)
{
	...
	/*-----------------------------------------------------------------------
		system_stm32f1xx.c 文件中 void SetSysClock(void) 函数对时钟的配置如下：
