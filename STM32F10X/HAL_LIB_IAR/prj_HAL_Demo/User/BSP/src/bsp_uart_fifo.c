...
#define USART1_AF_ENABLE()               __HAL_AFIO_REMAP_USART1_ENABLE()       //Remap     (TX/PB6, RX/PB7)
#define USART1_AF_DISABLE()              __HAL_AFIO_REMAP_USART1_DISABLE()      //No remap (TX/PA9, RX/PA10)
...
#define USART2_AF_ENABLE()               __HAL_AFIO_REMAP_USART2_ENABLE()       //Remap     (CTS/PD3, RTS/PD4, TX/PD5, RX/PD6, CK/PD7)
#define USART2_AF_DISABLE()              __HAL_AFIO_REMAP_USART2_DISABLE()      //No remap (CTS/PA0, RTS/PA1, TX/PA2, RX/PA3, CK/PA4)
...
#define USART3_AF_ENABLE()               __HAL_AFIO_REMAP_USART3_ENABLE()       //Full remap     (TX/PD8,  RX/PD9,  CK/PD10, CTS/PD11, RTS/PD12)
#define USART3_AF_PARTIAL()              __HAL_AFIO_REMAP_USART3_PARTIAL()      //Partial remap (TX/PC10, RX/PC11, CK/PC12, CTS/PB13, RTS/PB14)
#define USART3_AF_DISABLE()              __HAL_AFIO_REMAP_USART3_DISABLE()      //No remap      (TX/PB10, RX/PB11, CK/PB12, CTS/PB13, RTS/PB14)
...
*	形    参: _ucPort: 端口号(COM1 - COM8)
*			  _BaudRate: 波特率，8倍过采样  波特率.0-4.5Mbps
*                                16倍过采样 STM32F100xx 系列使用
*	返 回 值: 无
*********************************************************************************************************
*/
...
*	函 数 名: RS485_SetBaud
*	功能说明: 修改485串口的波特率。
*	形    参: _baud : 默认8倍过采样  波特率.4.5 MBits/s
*                     16倍过采样仅在 波特率.0-6.25Mbps
*	返 回 值: 无
*********************************************************************************************************
*/
...
*	功能说明: 配置串口的硬件参数（波特率，数据位，停止位，起始位，校验位，中断使能）适合于STM32F103开发板
