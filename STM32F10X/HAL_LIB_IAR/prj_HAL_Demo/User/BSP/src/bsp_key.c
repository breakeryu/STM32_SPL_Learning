...
static const X_GPIO_T s_gpio_list[HARD_KEY_NUM] = {
	{GPIOA, GPIO_PIN_0, GPIO_PULLDOWN, 1},		/* WK_UP */
	{GPIOE, GPIO_PIN_4, GPIO_PULLUP, 0},	    /* K0 */
	{GPIOE, GPIO_PIN_3, GPIO_PULLUP, 0},		/* K1 */
	{GPIOE, GPIO_PIN_2, GPIO_PULLUP, 0},		/* K2 */	
};	
...
static uint8_t IsKeyDownFunc(uint8_t _id)
{
	...
	{
		if (KeyPinActive(KID_K2) && KeyPinActive(KID_K0))
		{
			return 1;
		}
		else
...
{	
	...
	for (i = 0; i < HARD_KEY_NUM; i++)
	{
        ...
        gpio_init.Pull = s_gpio_list[i].pull;
